      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load6() {
            ...
            store.setPropertyType(com.vaadin.shared.ui.grid.GridState.class, "rowHeight", new Type(java.lang.Double.class));
          ...
          private void load8() {
            ...
            store.addOnStateChangeMethod(com.vaadin.client.connectors.grid.GridConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod("updateRowHeight", new String[] {"rowHeight", }));
          ...
          private void load9() {
            ...
            store.addOnStateChangeMethod(com.vaadin.client.ui.treegrid.TreeGridConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.connectors.grid.GridConnector.class, "updateColumnOrder", new String[] {"columnOrder", }));
            ...
            store.addOnStateChangeMethod(com.vaadin.client.ui.treegrid.TreeGridConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.connectors.grid.GridConnector.class, "updateFooter", new String[] {"footer", }));
            store.addOnStateChangeMethod(com.vaadin.client.ui.treegrid.TreeGridConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.connectors.grid.GridConnector.class, "updateHeader", new String[] {"header", }));
            ...
            store.addOnStateChangeMethod(com.vaadin.client.ui.treegrid.TreeGridConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.connectors.grid.GridConnector.class, "updateRowHeight", new String[] {"rowHeight", }));
          ...
          private native void loadNativeJs2(com.vaadin.client.metadata.TypeDataStore store) /*-{
            ...
            var data = {
              setter: function(bean, value) {
                bean.@com.vaadin.shared.ui.grid.GridState::rowHeight = value.@java.lang.Double::doubleValue()();
              },
              getter: function(bean) {
                return @java.lang.Double::valueOf(D)(bean.@com.vaadin.shared.ui.grid.GridState::rowHeight);
              }
            };
            store.@com.vaadin.client.metadata.TypeDataStore::setPropertyData(Ljava/lang/Class;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(@com.vaadin.shared.ui.grid.GridState::class, 'rowHeight', data);
